...
$$\begin{bmatrix} {}^{3}\boldsymbol{v}_3 \\ {}^{3}\omega_{z_3} \end{bmatrix} = \begin{bmatrix} L_1 s_2 \dot{\theta}_1 \\ L_1 c_2 \dot{\theta}_1 + L_2(\dot{\theta}_1 + \dot{\theta}_2) \\ \dot{\theta}_1 + \dot{\theta}_2 \end{bmatrix}_{3\times 1} = \underbrace{\begin{bmatrix} L_1 s_2 & 0 \\ L_1 c_2 + L_2 & L_2 \\ 1 & 1 \end{bmatrix}}_{{}^{3}\boldsymbol{J}_3 \;(3\times 2)} \begin{bmatrix} \dot{\theta}_1 \\ \dot{\theta}_2 \end{bmatrix}$$
